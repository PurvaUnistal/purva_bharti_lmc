...
class RFCInstallationData {
  Pager? pager;
  List<RFCInstallationRows>? rows;

  RFCInstallationData({this.pager, this.rows});

  RFCInstallationData.fromJson(Map<String, dynamic> json) {
    pager = json['pager'] != null ? new Pager.fromJson(json['pager']) : null;
    if (json['rows'] != null) {
      rows = <RFCInstallationRows>[];
      json['rows'].forEach((v) { rows!.add(new RFCInstallationRows.fromJson(v)); });
    }
  }
...
class RFCInstallationRows {
  ...
  RFCInstallationRows({this.id, this.hplcprojectId, this.createdOn, this.status, this.lmcId, this.dmaId, this.isReassigned, this.areaId, this.mobileNumber, this.firstName, this.middleName, this.lastName, this.guardianName, this.emailId, this.propertyCategoryId, this.propertyClassId, this.houseNumber, this.locality, this.town, this.district, this.state, this.pinCode, this.societyAllowedMdpe, this.residentStatus, this.noOfKitchen, this.noOfBathroom, this.existingCookingFuel, this.noOfFamilyMembers, this.ownerConsent, this.kycDocument1, this.kycDocument1Number, this.kycDocument2, this.kycDocument2Number, this.kycDocument3, this.kycDocument3Number, this.formStatus, this.dmaUserId, this.remarks, this.longitude, this.latitude, this.cgs, this.chargeAreaId, this.dateOfRegistration, this.nameOfBank, this.bankAccountNumber, this.bankIfscCode, this.bankAddress, this.dmaFormStatus, this.customerConsentStatus, this.reasonForHold, this.initialDepositeDate, this.modeOfDeposite, this.installmentNumber, this.payementBankName, this.paymentCreditStatus, this.dmaUserName, this.initialDepositeStatus, this.preferedBillingMode, this.acceptConversionPolicy, this.acceptExtraFittingCost, this.customerRegistrationNo, this.chequeNumber, this.marketingApprovStatus, this.accountApprovStatus, this.initialAmount, this.customerConsent, this.canceledCheque, this.crn, this.customerPhoto, this.housePhoto, this.kycDocument1Image, this.kycDocument2Image, this.kycDocument3Image, this.buildingNumber, this.address1, this.address2, this.backside1, this.backside2, this.backside3, this.chequeBankAccount, this.chequePhoto, this.isGasDepositApplicable, this.marketingApproval, this.markStatusTime, this.marketingRejectReason, this.accountingApproval, this.accountingTime, this.accontingRejectReason, this.depositeType, this.depositSlipDate, this.depositSlip, this.transactionId, this.transactionTime, this.transactionResponseTime, this.bpNumber, this.interested, this.assignLmcId, this.refundedAmount, this.refundOrderid, this.isGasdepositCollected, this.guardianType, this.selfRegistration, this.customerStatus, this.chequeBounceReason, this.micr, this.mobileResponseTime, this.isEdited, this.inAccount, this.bounceAmount, this.adjustableAmount, this.defermentAmount, this.districtId, this.disconnectionStatus, this.refundableStatu, this.saleId, this.collectionId, this.ageingId, this.trNumber, this.alternateMobile, this.dmaDirPath, this.refundableStatus, this.name, this.address, this.phoneNumber, this.email, this.password, this.userAreaMappingTable, this.areaMappingId, this.adminId, this.userId, this.userIndentId, this.companyName, this.assigendGa, this.assignedChargearea, this.textpassword, this.craetedDate, this.activatedDate, this.deactivatedDate, this.cityTown, this.lead, this.isHo, this.level, this.pwdChanged, this.moduleId, this.userTypeId, this.userImage, this.signImage, this.gid, this.objectid1, this.objectid, this.add, this.shapeLeng, this.projectCode, this.shapeLe1, this.shapeArea, this.dbname, this.labelForDashboard, this.gstNumber, this.panNumber, this.gaAddress, this.cinNumber, this.branchEmail, this.customerCare, this.vat, this.fax, this.cst, this.website, this.billingAddress, this.gaLabel, this.projectLogo, this.clientLogo, this.pmcLogo, this.contractorLogo, this.client, this.projectDesc, this.businessObject, this.pmc, this.contractor, this.gaCustomCode, this.areaName, this.areacode, this.cityId, this.subareacod, this.readyForConnection, this.dmaRegId, this.proposedDate, this.feasibilityVisitDate, this.additionalBom, this.createdAt, this.updatedAt, this.isFeasible, this.feasReason, this.followUpDate, this.deletedAt, this.source, this.extraPipePayment, this.installationStatus, this.modeOfDepositePayment, this.bounceCharge, this.bounceChargeTax, this.paymentCreditStatusLmc, this.invoiceNumber, this.invoiceAmount, this.extraPipe, this.totPipeLength, this.msgToCustomer, this.extraPipeUserId, this.invoiceDate, this.extraPipeStatus, this.meterNo, this.regulatorNo, this.lmcMeterReading, this.lastMeterReading, this.prevBalance, this.paidInstallment, this.actualLmcWorkStartedDate, this.tpaInspectionDate, this.ngcConversionDate, this.actualWorkStart, this.delayReason, this.meterType, this.meterMake, this.meterNumber, this.pipe, this.fittings, this.meterReading, this.meterReadingDate, this.meterPhoto, this.tfNumber, this.latitudeTf, this.longitudeTf, this.latitudeHg, this.longitudeHg, this.workCompletedDate, this.workCompletedImage, this.custAckImage, this.custAckDate, this.feasibilityId, this.extraPrice, this.cementingOfHoles, this.clampingPvc, this.claminngCopper, this.meterTesting, this.paintaingofGIpipe, this.conversionDate, this.typeOfNr, this.ngc, this.regulators, this.extraPipeId, this.isometricImage, this.isometricDate, this.pneumaticDate, this.pneumaticImage, this.rfcForm, this.tpaStatus, this.tpaRejectReason, this.tpaUserId, this.insExtraPipe, this.insExtraPrice, this.pipePaymentType, this.oldMeterNumber, this.meterReplacementDate, this.previousInstalledStatus, this.instDirPath, this.installationProcessStatus, this.rfcProcessStatus, this.assignId, this.isInstall, this.lmcFeasId, this.dma, this.states, this.dis, this.propName, this.propClass, this.installationId});
