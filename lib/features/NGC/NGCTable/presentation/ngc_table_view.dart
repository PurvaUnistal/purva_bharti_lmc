...
class _NgcTableViewState extends State<NgcTableView> {
  ...
  static const double _tableWidth =
      _wSno + _wReady +  _wReady + _wMobile + _wBp + _wArea + _wName + _wDate;
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            _headerCell("SAP AMC Status", _wReady),
  ...
  Widget _dataRow({
    required int index,
    required InstallationByNgcData user,
    required int pageNo,
  }) {
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            _rowCell(user.sapAmcStatus == "1" ? "Pending" : "Completed",_wReady, color: Colors.green[800]),
