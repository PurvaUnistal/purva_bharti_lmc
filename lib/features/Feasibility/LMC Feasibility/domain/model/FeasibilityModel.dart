...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['rows'] != null) {
      ...
      json['rows'].forEach((v) { rows!.add(new FeasibilityRowsList.fromJson(v)); });
    }
  }
