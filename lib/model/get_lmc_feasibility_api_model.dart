class GetLmcFeasibilityApiModel {
  int success;
  bool error;
  RowsData data;

  GetLmcFeasibilityApiModel({this.success, this.error, this.data});

  GetLmcFeasibilityApiModel.fromJson(Map<String, dynamic> json) {
    success = json['success'];
    error = json['error'];
    data = json['data'] != null ? new RowsData.fromJson(json['data']) : null;
  }
...
class GetLmcFeasibilityApiReqModel{
  final String schema;
  final String bpNumber;

  GetLmcFeasibilityApiReqModel({
    this.schema,
    this.bpNumber,
  });
  Map<String, dynamic> toJson() {
