...
class AppTextStyle {
  ...
  static final TextStyle dialogeText = TextStyle(
  ...
  static final TextStyle tableTitle = TextStyle(
  ...
  static final TextStyle bpNoTable = TextStyle(
    color: Colors.white,
    fontSize: 14,
    fontWeight: FontWeight.bold,
    fontStyle: FontStyle.normal,
  ...
  static final TextStyle textContent = TextStyle(
    color: AppColor.onBackground,
    fontSize: 14,
  ...
  static final TextStyle toolbarHeadline = TextStyle(
    // color: AppColor.onBackground,
    fontSize: 16,
    fontWeight: FontWeight.w600,
  );
