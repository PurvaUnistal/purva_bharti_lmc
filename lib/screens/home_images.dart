...
class _HomeImagesScreenState extends State<HomeImagesScreen> {
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: image1Controller.profileImage1!=null
                                  ? Image.file(image1Controller.profileImage1, width: 100,height: 100, fit: BoxFit.cover,)
                              ...
                              children: [
                                ...
                                InkWell(
                                  ...
                                  child: image2Controller.profileImage2 != null
                                      ? Image.file(image2Controller.profileImage2, width: 100,height: 100, fit: BoxFit.cover,)
                                      : Image.asset('assets/icons/place_holder.png', width: 100,height: 100,fit: BoxFit.cover,),
                                ),
                              ],
                            ),
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: image3Controller.profileImage3 != null
                                  ? Image.file(image3Controller.profileImage3, width: 100,height: 100, fit: BoxFit.cover,)
                                  : Image.asset('assets/icons/place_holder.png', width: 100,height: 100,fit: BoxFit.cover,),
                            ),
                          ],
                        ),
                          ...
                          children: [
                            ...
                            InkWell(
                              ...
                              child: image4Controller.profileImage4 != null
                                  ? Image.file(image4Controller.profileImage4, width: 100,height: 100, fit: BoxFit.cover,)
                                  : Image.asset('assets/icons/place_holder.png', width: 100,height: 100,fit: BoxFit.cover,),
                            ),
                          ],
                        ),
  ...
  /////////////////////////////  image 1 ///////////////////////////////////////
  Future<void> _openImageSource1(BuildContext mContext, PhotoController controller,) async {
  ...
  /////////////////////////////  image 2 ///////////////////////////////////////
  Future<void> _openImageSource2(BuildContext mContext, PhotoController controller,) async {
    return showDialog<void>(
      context: mContext,
      barrierDismissible: false,
      builder: (BuildContext context) {
  ...
  /////////////////////////////  image 3 ///////////////////////////////////////
  Future<void> _openImageSource3(BuildContext mContext, PhotoController controller,) async {
    return showDialog<void>(
      context: mContext,
      barrierDismissible: false,
      builder: (BuildContext context) {
  ...
  /////////////////////////////  image 4 ///////////////////////////////////////
  Future<void> _openImageSource4(BuildContext mContext, PhotoController controller,) async {
    return showDialog<void>(
      context: mContext,
      barrierDismissible: false,
      builder: (BuildContext context) {
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      image1Controller.profileImage1 == null
                          ...
                          : ImageCircle(fileImage1: image1Controller.profileImage1,pathImage: image1Controller.profileImage1.path.toString(),),
                    ],
                  ),
                  SizedBox(height: 10,),
                  Row(
                    ...
                    children: [
                      ...
                      image2Controller.profileImage2 == null
                          ...
                          : ImageCircle(fileImage1: image2Controller.profileImage2,pathImage: image2Controller.profileImage2.path.toString(),),
                    ],
                  ),
                  SizedBox(height: 10,),
                  Row(
                    ...
                    children: [
                      ...
                      image3Controller.profileImage3 == null
                          ...
                          : ImageCircle(fileImage1: image3Controller.profileImage3,pathImage: image3Controller.profileImage3.path.toString(),),
                    ],
                  ),
                  SizedBox(height: 10,),
                  Row(
                    ...
                    children: [
                      ...
                      image4Controller.profileImage4 == null
                          ...
                          : ImageCircle(fileImage1: image4Controller.profileImage4,pathImage: image4Controller.profileImage4.path.toString(),),
                    ],
                  ),
                  SizedBox(height: 10,),
                ],
