...
class OtherPaymentCollectionPage extends StatefulWidget {
  ...
  @override
  State<OtherPaymentCollectionPage> createState() =>
      _OtherPaymentCollectionPageState();
}

class _OtherPaymentCollectionPageState extends State<OtherPaymentCollectionPage>
  ...
  Future searchBpNumber() async {
    ...
    var response =
        await apiIntegration.getLMCFesApi(getLmcFeasibilityApiReqModel);
    setState(() {
      try {
        ...
        customerNameController.text = searchList.firstName.toString() +
            " " +
            searchList.lastName.toString();
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                          borderSide: BorderSide(
                            color:
                                null == Colors.grey ? Colors.teal : Colors.grey,
                            width: 1.0,
                          ),
                          borderRadius: BorderRadius.all(Radius.circular(10))),
                    ),
